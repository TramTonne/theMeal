        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-8 text-green-900">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input type="number" name="age" value={form.age} onChange={handleChange} className="w-full rounded-xl p-3 mt-1 bg-white" />
            </div>
              ...
              <div className="w-1/2">
                ...
                <div className="flex items-center mt-1">
                  <input
                    ...
                    placeholder="e.g. 170"
                  />
                  <span className="bg-gray-100 text-gray-700 px-3 py-3 rounded-r-xl">cm</span>
                </div>
              </div>
              ...
              <div className="w-1/2">
                ...
                <div className="flex items-center mt-1">
                  <input
                    ...
                    placeholder="e.g. 65"
                  />
                  <span className="bg-gray-100 text-gray-700 px-3 py-3 rounded-r-xl">kg</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 border-l border-green-900 pl-6">
            <div>
              ...
              <select name="exercise" value={form.exercise} onChange={handleChange} className="w-full rounded-xl p-3 mt-1 bg-white">
                <option value="">Select</option>
